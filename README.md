...
**① 誤変換（同音異義語）** — 「以外」→「意外」
```
入力: ご連絡が遅くなり申し訳ございません。以外と対応に時間がかかってしまいました。
出力: ご連絡が遅くなり申し訳ございません。意外と対応に時間がかかってしまいました。
```

**② 誤変換（同音異義語）** — 「機械」→「機会」
```
入力: またお会いできる機械を楽しみにしております。
出力: またお会いできる機会を楽しみにしております。
```

**③ 誤変換（同音異義語）** — 「確信」→「確認」
```
入力: 会議の開始時刻を変更したく、ご都合を確信させてください。
出力: 会議の開始時刻を変更したく、ご都合を確認させてください。
```

**④ 文字の入れ替わり（転置）** — 「ございすました」→「ございました」
```
入力: 先ほどはお電話ありがとうございすました。
出力: 先ほどはお電話ありがとうございました。
```

**⑤ 文字の入れ替わり（転置）** — 「しまた／しまうす」→「しました／します」
```
入力: 了解しまた。明日までに送付しまうす。
出力: 了解しました。明日までに送付いたします。
```

**⑥ 脱字** — 「お忙し中」「いだき」を補う
```
入力: 本日はお忙し中、お時間いだき、ありがとうございました。
出力: 本日はお忙しい中、お時間をいただき、ありがとうございました。
```

**⑦ 衍字（重複）** — 「ございますす」→「ございます」
```
入力: ご確認いただきありがとうございますす。
出力: ご確認いただきありがとうございます。
```

**⑧ 実戦的な崩れ（ローマ字残り＋誤変換の混在）**
```
入力: お世話になっておりまs。先日のけんで、資料をそうふいたしますのでごかくにんお願いします。
出力: お世話になっております。先日の会議で、資料を送付いたしますのでご確認をお願いします。
```
> 「おりま**s**」（ローマ字残り）「そうふ」「ごかくにん」をまとめて修正。
